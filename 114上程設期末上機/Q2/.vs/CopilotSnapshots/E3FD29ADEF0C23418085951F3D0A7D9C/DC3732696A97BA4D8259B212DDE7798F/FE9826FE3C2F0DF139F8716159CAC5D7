        ...
        private void SaveServiceDetailsToFile()
        {
            ...
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    // 使用 File.CreateText 建立檔案並取得 StreamWriter
                    ...
                    // 機油和潤滑服務
                    writer.WriteLine("【機油和潤滑服務】");
                    if (oilChangeCheckBox.Checked)
                        writer.WriteLine("  ✓ 更換機油 ........................ " + oil.ToString("C0"));
                    if (lubeCheckBox.Checked)
                        writer.WriteLine("  ✓ 潤滑保養 ........................ " + lube.ToString("C0"));
                    if (oilLubeTotal > 0)
                        writer.WriteLine("  小計：" + oilLubeTotal.ToString("C0"));
                    else
                        writer.WriteLine("  (未選擇任何項目)");
                    writer.WriteLine();

                    // 清洗服務
                    writer.WriteLine("【清洗服務】");
                    if (radiatorFlushCheckBox.Checked)
                        writer.WriteLine("  ✓ 水箱清洗 ........................ " + radiator.ToString("C0"));
                    if (transmissionFlushCheckBox.Checked)
                        writer.WriteLine("  ✓ 變速箱清洗 ...................... " + transmission.ToString("C0"));
                    if (flushTotal > 0)
                        writer.WriteLine("  小計：" + flushTotal.ToString("C0"));
                    else
                        writer.WriteLine("  (未選擇任何項目)");
                    writer.WriteLine();
                    ...
                    if (inspectionCheckBox.Checked)
                        writer.WriteLine("  ✓ 檢驗 ............................ " + inspection.ToString("C0"));
                    if (mufflerCheckBox.Checked)
                        writer.WriteLine("  ✓ 更換消音器 ...................... " + replace.ToString("C0"));
                    if (tireRotationCheckBox.Checked)
                        writer.WriteLine("  ✓ 輪胎換位 ........................ " + tire.ToString("C0"));
                    if (miscTotal > 0)
                        writer.WriteLine("  小計：" + miscTotal.ToString("C0"));
                    else
                        writer.WriteLine("  (未選擇任何項目)");
                    writer.WriteLine();
                    ...
                    if (parts > 0)
                        writer.WriteLine("  零件費用 .......................... " + parts.ToString("C0"));
                    
                    decimal laborHours = 0m;
                    decimal.TryParse(laborTextBox.Text, out laborHours);
                    if (laborHours > 0)
                    {
                        writer.WriteLine("  工時數量 .......................... " + laborHours.ToString("0.0") + " 小時");
                        writer.WriteLine("  工資費率 .......................... " + LABOR_RATE_PER_HOUR.ToString("C0") + "/小時");
                        writer.WriteLine("  工資費用 .......................... " + labor.ToString("C0"));
                    }
                    if (parts > 0 || labor > 0)
                        writer.WriteLine("  小計：" + otherTotal.ToString("C0"));
                    else
                        writer.WriteLine("  (無零件和工時費用)");
                    writer.WriteLine();
                    ...
                    writer.WriteLine("------------------------------------------------");
                    writer.WriteLine("  服務與工資總額 .................... " + (labor + oilLubeTotal + flushTotal + miscTotal).ToString("C0"));
                    writer.WriteLine("  零件費用 .......................... " + parts.ToString("C0"));
                    writer.WriteLine("  稅金 (零件 6%) .................... " + taxTotal.ToString("C0"));
                    writer.WriteLine("------------------------------------------------");
                    writer.WriteLine("  總費用 ............................ " + grandTotal.ToString("C0"));
                    writer.WriteLine("================================================");
                    writer.WriteLine();
                    writer.WriteLine("備註：");
                    writer.WriteLine("1. 所有金額均以新台幣 (NT$) 計算");
                    writer.WriteLine("2. 稅金僅對零件收取，稅率為 6%");
                    writer.WriteLine("3. 工資費率：NT$600/小時");
                    writer.WriteLine();
                    writer.WriteLine("感謝您的惠顧！");
                    writer.WriteLine("================================================");
